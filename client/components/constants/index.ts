...
const onboarding =[
  {
    ...
    description: "Access real-time updates and stay in the loop wherever you are, whenever you need.",
    image: require("@/assets/images/boarding1.png"),
  },
  {
    id: 2,
    title: "Personalized Experience",
    description: "Tailor your journey to suit your preferences and enjoy content that matters to you.",
    image: require("@/assets/images/boarding2.png"),
  },
  {
    id: 3,
    title: "Seamless Integration",
    description: "Connect effortlessly across devices and platforms for a unified experience.",
